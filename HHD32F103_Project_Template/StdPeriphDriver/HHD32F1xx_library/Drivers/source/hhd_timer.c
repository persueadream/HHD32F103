...
Function Definition	void TIM_Init(HHD32F1_TIM_TypeDef *ct, uint32_t tickpersecond)
...
Function Definition	void TIM_ConfigMatch(HHD32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t action)
...
Function Definition	void TIM_SetTimerCounter(HHD32F1_TIM_TypeDef *ct, uint16_t tick)
...
Function Definition	void TIM_ResetTimerCounter(HHD32F1_TIM_TypeDef *ct)
...
Function Definition	uint16_t TIM_GetTimerCounter(HHD32F1_TIM_TypeDef *ct)
...
Function Definition	void TIM_SelectTimerClearSignal(HHD32F1_TIM_TypeDef *ct, uint8_t capsignal, uint8_t edge)
...
Function Definition	void TIM_SelectPriSrc(HHD32F1_TIM_TypeDef *ct, uint8_t clksrc)
Function Description	Initial basic timer
Input Parameters	*ct: pointer to TIM2/TIM3
clksrc: clock source
				0000	CAP0 pin
...
/*****************************************************************************
Function Name	TIM_SelectPriSrc
Function Definition	void TIM_SelectSecSrc (HHD32F1_TIM_TypeDef *ct, uint8_t clksrc, uint8_t polarity)
Function Description	Initial basic timer
Input Parameters	*ct: pointer to TIM2/TIM3
clksrc: clock source
				0000	CAP0 pin
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigMatch0(HHD32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
{
	ct->MR0.bit.MATCH=ticks;
...
Function Definition	void TIM_ ConfigMatch1(HHD32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigMatch1(HHD32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
{
...
Function Definition	void TIM_ConfigMatch2(HHD32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigMatch2(HHD32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
{
...
Function Definition	void TIM_ConfigMatch3(HHD32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
...
Last Chang Date: 2015/09/12			
*****************************************************************************/
void TIM_ConfigMatch3(HHD32F1_TIM_TypeDef *ct, uint16_t ticks, uint8_t internalaction, uint8_t externalaction)
{
	ct->MR1.bit.MATCH=ticks;
...
Function Definition	void TIM_ConfigCapture0 (HHD32F1_TIM_TypeDef *ct, uint8_t edge, uint8_t intreq)
...
Function Definition	void TIM_ConfigCapture3 (HHD32F1_TIM_TypeDef *ct, uint8_t edge, uint8_t intreq)
...
Function Definition	void TIM_GetCapture0Value(HHD32F1_TIM_TypeDef *ct)
...
Function Definition	void TIM_GetCapture1Value(HHD32F1_TIM_TypeDef *ct)
...
Function Definition	void TIM_GetCapture2Value(HHD32F1_TIM_TypeDef *ct)
...
Function Definition	void TIM_GetCapture3Value(HHD32F1_TIM_TypeDef *ct)
...
Function Definition	void TIM_START(HHD32F1_TIM_TypeDef *ct)
...
Function Definition	void TIM_STOP(HHD32F1_TIM_TypeDef *ct)
Function Description	
Input Parameters	*ct: pointer to 
Return Value	No
Condition	No
...
Function Definition	void TIM_RESET(HHD32F1_TIM_TypeDef *ct)
Function Description	
Input Parameters	*ct: pointer to 
Return Value	No
Condition	No
