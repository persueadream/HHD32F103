...
** 
*****************************************************************************/
void PWM_Init(HHD32F1_PWM_TypeDef *PWM,uint16_t freq,uint8_t pair, uint8_t align, uint8_t polarity)
{
...
** 
*****************************************************************************/
void PWM_EnableFaultProtect(HHD32F1_PWM_TypeDef *PWM,uint8_t faults, uint8_t cleartype, uint8_t faultint)
{
	switch(faults)
	{
		case 0:
