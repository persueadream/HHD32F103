/*****************************************************************************
 *   hhd_gpio:  Sourse file for  MCU GPIO application
 *
...
Function Definition	void GPIO_SetPinsAsInput(HHD32F_GPIO_TypeDef *port, uint16_t pins)
Function Description	Setup GPIO pins as digital input
Input Parameters	* port : pointer to GPIO device, HHD_GPIO0/HHD_GPIO1/HHD_GPIO2
...
Function Definition	void GPIO_SetPinsAsOutput(HHD32F_GPIO_TypeDef *port, uint16_t pins)
...
Function Definition	void GPIO_SetPin (HHD32F_GPIO_TypeDef *port, uint16_t pin)
...
Function Definition	void GPIO_ResetPin (HHD32F_GPIO_TypeDef *port, uint16_t pin)
...
Function Definition	void GPIO_InvertOutPin (HHD32F_GPIO_TypeDef *port, uint16_t pin)
...
Function Definition	uint8_t GPIO_GetPinState(HHD32F_GPIO_TypeDef *port, uint16_t pin)
...
Function Definition	uint16_t GPIO_GetPortState(HHD32F_GPIO_TypeDef *port)
...
Function Definition	void GPIO_SetPortMask(HHD32F_GPIO_TypeDef *port, uint16_t pins)
...
Function Definition	void GPIO_ResetPortMask(HHD32F_GPIO_TypeDef *port, uint16_t pins)
...
Function Definition	uint16_t GPIO_ReadPort(HHD32F_GPIO_TypeDef *port)
...
Function Definition	void GPIO_WritePort(HHD32F_GPIO_TypeDef *port, uint16_t data)
...
Function Definition	void GPIO_EnableInt(HHD32F_GPIO_TypeDef *port, uint16_t pin, uint8_t triggeredge)
...
Function Definition	void GPIO_ClrIntflag(HHD32F_GPIO_TypeDef *port, uint16_t pin)
Function Description	Setup GPIO pin interrupt
Input Parameters	* port : pointer to GPIO device, HHD_GPIO0/HHD_GPIO1/HHD_GPIO2
pin: IO_PIN0~IO_PIN15, predefine in sys.h
triggeredge: RISE_EDGE/FALL_EDGE/BOTH_EDGE
...
Function Definition	void GPIO_DisableInt(HHD32F_GPIO_TypeDef *port, uint16_t pin)
Function Description	Setup GPIO pin interrupt
Input Parameters	* port : pointer to GPIO device, HHD_GPIO0/HHD_GPIO1/HHD_GPIO2
pin: IO_PIN0~IO_PIN15, predefine in sys.h
triggeredge: RISE_EDGE/FALL_EDGE/BOTH_EDGE
